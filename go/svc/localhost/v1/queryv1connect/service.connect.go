...
const (
	...
	LocalhostServiceName = "svc.query.v1.LocalhostService"
)
...
const (
	...
	LocalhostServicePingProcedure = "/svc.query.v1.LocalhostService/Ping"
)
...
// LocalhostServiceClient is a client for the svc.query.v1.LocalhostService service.
type LocalhostServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewLocalhostServiceClient constructs a client for the svc.query.v1.LocalhostService service. By
...
// Ping calls svc.query.v1.LocalhostService.Ping.
...
// LocalhostServiceHandler is an implementation of the svc.query.v1.LocalhostService service.
...
func NewLocalhostServiceHandler(svc LocalhostServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/svc.query.v1.LocalhostService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLocalhostServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.query.v1.LocalhostService.Ping is not implemented"))
}
