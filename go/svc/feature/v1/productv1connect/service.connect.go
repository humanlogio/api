...
const (
	...
	FeatureServiceName = "svc.product.v1.FeatureService"
)
...
const (
	...
	// RPC.
	FeatureServiceHasFeatureProcedure = "/svc.product.v1.FeatureService/HasFeature"
)
...
// FeatureServiceClient is a client for the svc.product.v1.FeatureService service.
...
// NewFeatureServiceClient constructs a client for the svc.product.v1.FeatureService service. By
...
// HasFeature calls svc.product.v1.FeatureService.HasFeature.
...
// FeatureServiceHandler is an implementation of the svc.product.v1.FeatureService service.
...
func NewFeatureServiceHandler(svc FeatureServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/svc.product.v1.FeatureService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFeatureServiceHandler) HasFeature(context.Context, *connect.Request[v1.HasFeatureRequest]) (*connect.Response[v1.HasFeatureResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.product.v1.FeatureService.HasFeature is not implemented"))
}
