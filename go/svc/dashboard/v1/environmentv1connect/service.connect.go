...
const (
	...
	DashboardServiceName = "svc.environment.v1.DashboardService"
)
...
// NewDashboardServiceClient constructs a client for the svc.environment.v1.DashboardService
...
func (UnimplementedDashboardServiceHandler) ListDashboard(context.Context, *connect.Request[v1.ListDashboardRequest]) (*connect.Response[v1.ListDashboardResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.environment.v1.DashboardService.ListDashboard is not implemented"))
}
