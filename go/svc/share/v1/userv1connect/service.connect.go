...
const (
	...
	PublicShareServiceName = "svc.user.v1.PublicShareService"
	// UserShareServiceName is the fully-qualified name of the UserShareService service.
	UserShareServiceName = "svc.user.v1.UserShareService"
)
...
const (
	...
	PublicShareServiceViewSharedResultProcedure = "/svc.user.v1.PublicShareService/ViewSharedResult"
	...
	UserShareServiceCreateUserSharedResultProcedure = "/svc.user.v1.UserShareService/CreateUserSharedResult"
	...
	UserShareServiceGetUserSharedResultProcedure = "/svc.user.v1.UserShareService/GetUserSharedResult"
	...
	UserShareServiceUpdateUserSharedResultProcedure = "/svc.user.v1.UserShareService/UpdateUserSharedResult"
	...
	UserShareServiceDeleteUserSharedResultProcedure = "/svc.user.v1.UserShareService/DeleteUserSharedResult"
	...
	UserShareServiceListUserSharedResultProcedure = "/svc.user.v1.UserShareService/ListUserSharedResult"
)

// PublicShareServiceClient is a client for the svc.user.v1.PublicShareService service.
...
// NewPublicShareServiceClient constructs a client for the svc.user.v1.PublicShareService service.
...
// ViewSharedResult calls svc.user.v1.PublicShareService.ViewSharedResult.
...
// PublicShareServiceHandler is an implementation of the svc.user.v1.PublicShareService service.
...
func NewPublicShareServiceHandler(svc PublicShareServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/svc.user.v1.PublicShareService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPublicShareServiceHandler) ViewSharedResult(context.Context, *connect.Request[v1.ViewSharedResultRequest]) (*connect.Response[v1.ViewSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.PublicShareService.ViewSharedResult is not implemented"))
}

// UserShareServiceClient is a client for the svc.user.v1.UserShareService service.
...
// NewUserShareServiceClient constructs a client for the svc.user.v1.UserShareService service. By
...
// CreateUserSharedResult calls svc.user.v1.UserShareService.CreateUserSharedResult.
...
// GetUserSharedResult calls svc.user.v1.UserShareService.GetUserSharedResult.
...
// UpdateUserSharedResult calls svc.user.v1.UserShareService.UpdateUserSharedResult.
...
// DeleteUserSharedResult calls svc.user.v1.UserShareService.DeleteUserSharedResult.
...
// ListUserSharedResult calls svc.user.v1.UserShareService.ListUserSharedResult.
...
// UserShareServiceHandler is an implementation of the svc.user.v1.UserShareService service.
...
func NewUserShareServiceHandler(svc UserShareServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/svc.user.v1.UserShareService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserShareServiceHandler) CreateUserSharedResult(context.Context, *connect.Request[v1.CreateUserSharedResultRequest]) (*connect.Response[v1.CreateUserSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.UserShareService.CreateUserSharedResult is not implemented"))
}
...
func (UnimplementedUserShareServiceHandler) GetUserSharedResult(context.Context, *connect.Request[v1.GetUserSharedResultRequest]) (*connect.Response[v1.GetUserSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.UserShareService.GetUserSharedResult is not implemented"))
}
...
func (UnimplementedUserShareServiceHandler) UpdateUserSharedResult(context.Context, *connect.Request[v1.UpdateUserSharedResultRequest]) (*connect.Response[v1.UpdateUserSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.UserShareService.UpdateUserSharedResult is not implemented"))
}
...
func (UnimplementedUserShareServiceHandler) DeleteUserSharedResult(context.Context, *connect.Request[v1.DeleteUserSharedResultRequest]) (*connect.Response[v1.DeleteUserSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.UserShareService.DeleteUserSharedResult is not implemented"))
}
...
func (UnimplementedUserShareServiceHandler) ListUserSharedResult(context.Context, *connect.Request[v1.ListUserSharedResultRequest]) (*connect.Response[v1.ListUserSharedResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("svc.user.v1.UserShareService.ListUserSharedResult is not implemented"))
}
