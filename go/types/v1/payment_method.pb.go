...
func (m *PaymentMethod) GetType() isPaymentMethod_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *PaymentMethod) GetCard() *PaymentMethod_Card {
	if x, ok := x.GetType().(*PaymentMethod_Card_); ok {
		return x.Card
	}
	return nil
}
...
var file_types_v1_payment_method_proto_rawDesc = []byte{
...
var (
	...
	file_types_v1_payment_method_proto_rawDescData = file_types_v1_payment_method_proto_rawDesc
)

func file_types_v1_payment_method_proto_rawDescGZIP() []byte {
	file_types_v1_payment_method_proto_rawDescOnce.Do(func() {
		file_types_v1_payment_method_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_v1_payment_method_proto_rawDescData)
	})
...
func file_types_v1_payment_method_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_types_v1_payment_method_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_types_v1_payment_method_proto_rawDesc = nil
