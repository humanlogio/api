...
var file_types_v1_subscription_proto_rawDesc = []byte{
...
var (
	...
	file_types_v1_subscription_proto_rawDescData = file_types_v1_subscription_proto_rawDesc
)

func file_types_v1_subscription_proto_rawDescGZIP() []byte {
	file_types_v1_subscription_proto_rawDescOnce.Do(func() {
		file_types_v1_subscription_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_v1_subscription_proto_rawDescData)
	})
...
func file_types_v1_subscription_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_types_v1_subscription_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_types_v1_subscription_proto_rawDesc = nil
