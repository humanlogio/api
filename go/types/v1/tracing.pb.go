...
const file_types_v1_tracing_proto_rawDesc = "" +
	"\n" +
	"\x16types/v1/tracing.proto\x12\btypes.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14types/v1/types.proto\"H\n" +
	"\x05Trace\x12\x19\n" +
	"\btrace_id\x18\x01 \x01(\tR\atraceId\x12$\n" +
	"\x05spans\x18\x02 \x03(\v2\x0e.types.v1.SpanR\x05spans\"\xe2\t\n" +
	"\x04Span\x12\x19\n" +
	...
	"\x05scope\x18\t \x01(\v2\x14.types.v1.Span.ScopeR\x05scope\x12-\n" +
	"\x06timing\x18\n" +
	" \x01(\v2\x15.types.v1.Span.TimingR\x06timing\x12=\n" +
	"\x13resource_attributes\x18\v \x03(\v2\f.types.v1.KVR\x12resourceAttributes\x125\n" +
	"\x0fspan_attributes\x18\f \x03(\v2\f.types.v1.KVR\x0espanAttributes\x12,\n" +
	"\x06events\x18\r \x03(\v2\x14.types.v1.Span.EventR\x06events\x12)\n" +
	"\x05links\x18\x0e \x03(\v2\x13.types.v1.Span.LinkR\x05links\x12-\n" +
	"\x06status\x18\x0f \x01(\v2\x15.types.v1.Span.StatusR\x06status\x1au\n" +
	"\x05Event\x128\n" +
	...
	"\bCONSUMER\x10\x05B\x8c\x01\n" +
	"\fcom.types.v1B\fTracingProtoP\x01Z-github.com/humanlogio/api/go/types/v1;typesv1\xa2\x02\x03TXX\xaa\x02\bTypes.V1\xca\x02\bTypes\\V1\xe2\x02\x14Types\\V1\\GPBMetadata\xea\x02\tTypes::V1b\x06proto3"
