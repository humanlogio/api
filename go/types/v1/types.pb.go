...
const file_types_v1_types_proto_rawDesc = "" +
	...
	"\x04rows\x18\x02 \x03(\v2\r.types.v1.ArrR\x04rows\"\xf2\x01\n" +
	"\x0eDataStreamType\x125\n" +
	"\x05multi\x18\x01 \x01(\v2\x1d.types.v1.MultiDataStreamTypeH\x00R\x05multi\x121\n" +
	"\atabular\x18\x02 \x01(\v2\x15.types.v1.TabularTypeH\x00R\atabular\x126\n" +
	"\fsingle_value\x18\x03 \x01(\v2\x11.types.v1.VarTypeH\x00R\vsingleValue\x126\n" +
	"\n" +
	"timeseries\x18\x05 \x01(\v2\x14.types.v1.TimeseriesH\x00R\n" +
	"timeseriesB\x06\n" +
	"\x04type\"I\n" +
	"\x13MultiDataStreamType\x122\n" +
	"\astreams\x18\x01 \x01(\v2\x18.types.v1.DataStreamTypeR\astreams\"\xdb\x01\n" +
	"\vTabularType\x12+\n" +
	"\x05table\x18\x01 \x01(\v2\x13.types.v1.TableTypeH\x00R\x05table\x12C\n" +
	"\n" +
	"log_events\x18\x02 \x01(\v2\".types.v1.TabularType.LogEventTypeH\x00R\tlogEvents\x126\n" +
	"\x05spans\x18\x03 \x01(\v2\x1e.types.v1.TabularType.SpanTypeH\x00R\x05spans\x1a\x0e\n" +
	"\fLogEventType\x1a\n" +
	"\n" +
	"\bSpanTypeB\x06\n" +
	"\x04type\"3\n" +
	"\n" +
	"Timeseries\x12%\n" +
	"\x04type\x18\x01 \x01(\v2\x11.types.v1.VarTypeR\x04type*Y\n" +
	"\n" +
	"ScalarType\x12\v\n" +
