...
/**
 * @generated from message svc.environment.v1.CreateDashboardRequest
 */
export class CreateDashboardRequest extends Message<CreateDashboardRequest> {
  ...
  static readonly typeName = "svc.environment.v1.CreateDashboardRequest";
...
/**
 * @generated from message svc.environment.v1.CreateDashboardResponse
 */
export class CreateDashboardResponse extends Message<CreateDashboardResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.CreateDashboardResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.environment.v1.UpdateDashboardRequest
 */
export class UpdateDashboardRequest extends Message<UpdateDashboardRequest> {
  /**
   * @generated from field: repeated svc.environment.v1.UpdateDashboardRequest.Mutation mutations = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.UpdateDashboardRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.environment.v1.UpdateDashboardRequest.Mutation
 */
export class UpdateDashboardRequest_Mutation extends Message<UpdateDashboardRequest_Mutation> {
  /**
   * @generated from oneof svc.environment.v1.UpdateDashboardRequest.Mutation.do
   */
  do: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.UpdateDashboardRequest.Mutation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.environment.v1.UpdateDashboardResponse
 */
export class UpdateDashboardResponse extends Message<UpdateDashboardResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.UpdateDashboardResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "dashboard", kind: "message", T: Dashboard },
  ]);
...
/**
 * @generated from message svc.environment.v1.DeleteDashboardRequest
 */
export class DeleteDashboardRequest extends Message<DeleteDashboardRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.DeleteDashboardRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message svc.environment.v1.DeleteDashboardResponse
 */
export class DeleteDashboardResponse extends Message<DeleteDashboardResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.environment.v1.DeleteDashboardResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
