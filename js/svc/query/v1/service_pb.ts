...
import { Obj, Scalar, Table, VarType } from "../../../types/v1/types_pb";
...
export class QueryResponse extends Message<QueryResponse> {
  ...
  /**
   * @generated from field: svc.query.v1.Data data = 200;
   */
  data?: Data;
...
/**
 * @generated from message svc.query.v1.Data
 */
export class Data extends Message<Data> {
  /**
   * Schema schema = 1;
   *
   * @generated from oneof svc.query.v1.Data.shape
   */
  shape: {
    /**
     ...
     * more queries.
     *
     * @generated from field: svc.query.v1.SubQueries subqueries = 201;
     */
    value: SubQueries;
    case: "subqueries";
  } | {
     ...
     * header
     *
     * @generated from field: svc.query.v1.Tabular tabular = 301;
     */
    value: Tabular;
    case: "tabular";
  } | {
     ...
     * a numeric value
     *
     * @generated from field: svc.query.v1.ScalarTimeseries scalar_timeseries = 401;
     */
     ...
     *
     * @generated from field: svc.query.v1.VectorTimeseries vector_timeseries = 402;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.Data";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.query.v1.SubQueries
 */
export class SubQueries extends Message<SubQueries> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.SubQueries";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.query.v1.Tabular
 */
export class Tabular extends Message<Tabular> {
  ...
  /**
   * @generated from oneof svc.query.v1.Tabular.shape
   */
  shape: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.Tabular";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message svc.query.v1.ScalarTimeseries
 */
export class ScalarTimeseries extends Message<ScalarTimeseries> {
  ...
  /**
   * @generated from field: repeated svc.query.v1.ScalarTimestamp scalars = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.ScalarTimeseries";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "context", kind: "message", T: Obj },
...
/**
 * @generated from message svc.query.v1.ScalarTimestamp
 */
export class ScalarTimestamp extends Message<ScalarTimestamp> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.ScalarTimestamp";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "ts", kind: "message", T: Timestamp },
...
/**
 * @generated from message svc.query.v1.VectorTimeseries
 */
export class VectorTimeseries extends Message<VectorTimeseries> {
  ...
  /**
   * @generated from field: repeated svc.query.v1.VectorTimestamp vectors = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.VectorTimeseries";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "context", kind: "message", T: Obj },
    { no: 2, name: "type", kind: "enum", T: proto3.getEnumType(VarType) },
...
/**
 * @generated from message svc.query.v1.VectorTimestamp
 */
export class VectorTimestamp extends Message<VectorTimestamp> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "svc.query.v1.VectorTimestamp";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "ts", kind: "message", T: Timestamp },
